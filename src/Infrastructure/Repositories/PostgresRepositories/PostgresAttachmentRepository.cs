...
{
    public class PostgresAttachmentRepository(NpgsqlConnection connection) : IAttachmentRepository
    {
        ...
        {
            var sql = @"SELECT id, file_name, stored_path, content_type, size, created_at 
