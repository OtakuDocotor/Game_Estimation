...
namespace Infrastructure.Database.Migrations
{
    ...
    public class AddAttachments : Migration
    {
        public override void Up()
        {
            ...
            Create.ForeignKey("fk_users_logo_attachment_id")
                .FromTable("developers").ForeignColumn("logo_attachment_id")
                .ToTable("attachments").PrimaryColumn("id")
                .OnDeleteOrUpdate(Rule.SetNull);
        ...
        public override void Down()
        {
            ...
            Delete.ForeignKey("fk_users_logo_attachment_id").OnTable("developer");
            Delete.Column("logo_attachment_id").FromTable("developer");
